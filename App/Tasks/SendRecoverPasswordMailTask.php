...
/**
 * SendRecoverPasswordMailTask handles the execution of a specific task and provides
...
class SendRecoverPasswordMailTask extends BaseTask
{
    /**
    ...
    {
        if ($this->payload) {
            Mail::send(new ResetPasswordEmailNotification($this->payload));
